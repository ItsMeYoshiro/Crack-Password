...
show_help() {
    ...
    $0 -a shal -H hash -w wordlist.txt
        ...
        "ALGO")
            ...
            then
                ...
                ;;
                    ...
                    *)
                    echo -e "\n${VERMELHO} Erro! Algoritmos aceitos: base64, md5, shal, sha256, sha512."
                    ;;
...
go_crack () {
    ...
    then
        ...
        [[ ! -f "$WORDLIST" ]] && echo -e "\n${VERMELHO}Erro! Worlist não encontrada\n" && exit 1
        [[ ! -r "$WORDLIST" ]] && echo -e "\n${Vermelho}Erro! Wordlist sem permisão de leitura\n" && exit 1
